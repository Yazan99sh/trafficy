...
class S {
  ...
  /// `Welcome to trafficy_captain`
  String get welcomeTotrafficy_captain {
    return Intl.message(
      'Welcome to trafficy_captain',
      name: 'welcomeTotrafficy_captain',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Please Download trafficy_captain`
  String get pleaseDownloadtrafficy_captain {
    return Intl.message(
      'Please Download trafficy_captain',
      name: 'pleaseDownloadtrafficy_captain',
      desc: '',
      args: [],
    );
  }
